...
Future<void> generateReporteComedorAlumno(
  List<ResponseComedor> data,
  String mes,
  int alumnoId,
) async {
  var datos = data;
                ...
                return pw.Column(
                  children: [
                    ...
                    pw.TableHelper.fromTextArray(
                      context: context,
                      headers: <String>['Fecha', 'Importe', 'Referencia'],
                      data:
                          datos
                              .map(
                                (e) => [
                                  (formatOnlyDate.format(e.fecha)),
                                  (e.importe.toString()),
                                  (e.movimientoId.toString()),
                                ],
                              )
                              .toList(),
  ...
  final reportesDir = Directory('$path/reportes/Comedor/$mes');
  ...
  File file = File(
    '$path/reportes/Comedor/$mes/${alumno.apellido}-${alumno.nombre}-$fecha1.pdf',
  );
