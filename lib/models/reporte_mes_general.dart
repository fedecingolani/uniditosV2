...
List<ReporteMes> reoporteFromMap(String str) =>
    List<ReporteMes>.from(json.decode(str).map((x) => ReporteMes.fromMap(x)));

class ReporteMes {
  String nombreSala;
  List<Dato> datos;

  ReporteMes({required this.nombreSala, required this.datos});

  factory ReporteMes.fromJson(String str) =>
      ReporteMes.fromMap(json.decode(str));
...
class Dato {
  ...
  Dato({
    ...
    required this.minutos1,
    required this.minutos2,
    required this.minutos3,
  });
  ...
  factory Dato.fromMap(Map<String, dynamic> json) => Dato(
    ...
    minutos1: json["minutos1"]?.toDouble(),
    minutos2: json["minutos2"]?.toDouble(),
    minutos3: json["minutos3"]?.toDouble(),
  );
...
class Movimiento {
  ...
  factory Movimiento.fromMap(Map<String, dynamic> json) => Movimiento(
    ...
    fechaEgreso:
        json["fechaEgreso"] == null
            ? null
            : DateTime.parse(json["fechaEgreso"]),
  );
